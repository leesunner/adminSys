          ...
          <el-tab-pane label="文章基本配置" name="first">
            <el-col>
              ...
              <el-form-item label="文章作者">
                <el-input clearable placeholder="请输入文章作者" v-model="columnData.author"></el-input>
              </el-form-item>
              <el-form-item label="文章来源">
                <el-input clearable placeholder="请输入文章来源" v-model="columnData.copyFrom"></el-input>
              </el-form-item>
              ...
              <el-row>
                <el-form-item label="文章封面图" prop="image">
                  ...
                  <el-row style="padding-left: 12px;font-size: 12px;color: #f56c6c;">* 上传限制一张</el-row>
                </el-form-item>
              </el-row>
              <el-row>
